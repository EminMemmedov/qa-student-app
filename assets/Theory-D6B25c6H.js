import{t as e}from"./useTranslation-DOlbVM-v.js";import{t}from"./arrow-left-CEKbB1e3.js";import{t as n}from"./chevron-right-x71Xyaud.js";import{t as r}from"./circle-check-big-DijlB_v5.js";import{t as i}from"./circle-x-DJWJ-bW3.js";import{t as a}from"./info-CrP0PA2J.js";import{t as o}from"./sparkles-DNqw5SIE.js";import{t as s}from"./target-CLlLgVvL.js";import{C as c,S as l,_ as u,a as d,d as f,f as p,g as m,o as h,p as g,w as _,y as v}from"./index-CpAWqZKz.js";import{t as y}from"./confetti.module-DC3TM9F_.js";import{t as b}from"./PageTransition-DEgSI7_f.js";var x=g(`file-check`,[[`path`,{d:`M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z`,key:`1oefj6`}],[`path`,{d:`M14 2v5a1 1 0 0 0 1 1h5`,key:`wfsgrz`}],[`path`,{d:`m9 15 2 2 4-4`,key:`1grp1n`}]]);const S=[{id:`qa-basics`,title:`QA Əsasları`,description:`Testləşdirmənin əsas prinsipləri və QA mühəndisinin rolu`,color:`bg-gradient-to-br from-blue-500 to-cyan-500`,content:`### QA Nədir?
...
- Yeni baq tapılmadığından əmin ol`,quiz:[{question:`Test Planı nədir?`,options:[`Baq reportu`,`Testləşdirmə prosesinin yol xəritəsi`,`Kodun bir hissəsi`,`Dizayn sənədi`],correct:1},{question:`Test Scope nəyi müəyyən edir?`,options:[`Nəyin test ediləcəyini və edilməyəcəyini`,`Testin qiymətini`,`Developerlərin adlarını`,`Layihənin bitmə tarixini`],correct:0},{question:`Boundary Testing nəyi yoxlayır?`,options:[`Rəngləri`,`Sərhəd dəyərlərini (min/max)`,`Sürəti`,`Təhlükəsizliyi`],correct:1}]}];var C=_(),w=m(),T={"qa-basics":f,"test-types":x,"bug-reporting":s,"test-planning":o},E={"qa-basics":`/theory-qa-basics.png`,"test-types":`/theory-test-types.png`,"bug-reporting":`/theory-bug-reporting.png`,"test-planning":`/theory-test-planning.png`},D=({content:e})=>(0,w.jsx)(`div`,{className:`prose prose-slate prose-lg max-w-none`,children:e.split(`
`).map((e,t)=>e.trim().startsWith(`###`)?(0,w.jsxs)(`h3`,{className:`text-2xl font-black mt-10 mb-6 text-slate-800 flex items-center gap-3`,children:[(0,w.jsx)(`span`,{className:`w-1.5 h-8 bg-gradient-to-b from-indigo-500 to-purple-500 rounded-full`}),e.replace(`###`,``).trim()]},t):e.trim().startsWith(`**`)&&e.trim().endsWith(`**`)?(0,w.jsx)(`div`,{className:`bg-indigo-50 border-l-4 border-indigo-500 p-5 rounded-r-2xl my-6 shadow-sm`,children:(0,w.jsxs)(`strong`,{className:`text-indigo-900 font-bold flex items-start gap-3`,children:[(0,w.jsx)(a,{className:`w-6 h-6 text-indigo-600 flex-shrink-0 mt-0.5`}),(0,w.jsx)(`span`,{children:e.replace(/\*\*/g,``)})]})},t):e.trim().startsWith(`-`)?(0,w.jsxs)(`li`,{className:`ml-6 list-none pl-2 mb-3 relative flex items-start gap-3`,children:[(0,w.jsx)(`span`,{className:`w-1.5 h-1.5 rounded-full bg-indigo-500 mt-2.5 flex-shrink-0`}),(0,w.jsx)(`span`,{className:`text-slate-700 leading-relaxed text-lg`,children:e.replace(`-`,``).trim()})]},t):e.trim().startsWith("```")?null:e.trim()===``?(0,w.jsx)(`br`,{},t):(0,w.jsx)(`p`,{className:`text-slate-600 leading-relaxed mb-4 text-lg`,children:e},t))}),O=({quiz:t,onComplete:n})=>{let{t:a}=e(),[s,c]=(0,C.useState)({}),[l,u]=(0,C.useState)(!1),d=(e,t)=>{l||c(n=>({...n,[e]:t}))},f=()=>{u(!0),t.every((e,t)=>s[t]===e.correct)&&(y({particleCount:100,spread:70,origin:{y:.6}}),n())},p=Object.keys(s).length===t.length;return(0,w.jsxs)(`div`,{className:`mt-12 bg-slate-50 rounded-3xl p-8 border border-slate-200`,children:[(0,w.jsxs)(`h3`,{className:`text-2xl font-black text-slate-900 mb-6 flex items-center gap-3`,children:[(0,w.jsx)(o,{className:`text-yellow-500`}),a(`theory.quiz.title`)]}),(0,w.jsx)(`div`,{className:`space-y-8`,children:t.map((e,t)=>(0,w.jsxs)(`div`,{className:`bg-white p-6 rounded-2xl shadow-sm border border-slate-100`,children:[(0,w.jsxs)(`p`,{className:`font-bold text-lg text-slate-800 mb-4`,children:[t+1,`. `,e.question]}),(0,w.jsx)(`div`,{className:`space-y-3`,children:e.options.map((n,a)=>{let o=s[t]===a,c=e.correct===a,u=`w-full text-left p-4 rounded-xl border-2 transition-all duration-200 flex items-center justify-between `;return l?c?u+=`border-green-500 bg-green-50 text-green-900`:o?u+=`border-red-500 bg-red-50 text-red-900`:u+=`border-slate-100 text-slate-500 opacity-50`:o?u+=`border-indigo-500 bg-indigo-50 text-indigo-900`:u+=`border-slate-100 hover:border-indigo-200 hover:bg-slate-50 text-slate-700`,(0,w.jsxs)(`button`,{onClick:()=>d(t,a),disabled:l,className:u,children:[(0,w.jsx)(`span`,{className:`font-medium`,children:n}),l&&c&&(0,w.jsx)(r,{size:20,className:`text-green-500`}),l&&o&&!c&&(0,w.jsx)(i,{size:20,className:`text-red-500`})]},a)})})]},t))}),!l&&(0,w.jsx)(`button`,{onClick:f,disabled:!p,className:`mt-8 w-full py-4 rounded-xl font-bold text-lg transition-all ${p?`bg-indigo-600 text-white shadow-lg shadow-indigo-500/30 hover:bg-indigo-700 transform hover:-translate-y-1`:`bg-slate-200 text-slate-400 cursor-not-allowed`}`,children:a(`theory.quiz.checkResults`)}),l&&(0,w.jsxs)(`div`,{className:`mt-8 p-6 bg-white rounded-2xl border border-slate-100 text-center`,children:[(0,w.jsx)(`p`,{className:`text-xl font-bold text-slate-900 mb-2`,children:a(`theory.quiz.correctAnswers`,{correct:t.filter((e,t)=>s[t]===e.correct).length,total:t.length})}),t.every((e,t)=>s[t]===e.correct)?(0,w.jsx)(`p`,{className:`text-green-600 font-medium`,children:a(`theory.quiz.excellent`)}):(0,w.jsx)(`p`,{className:`text-orange-500 font-medium`,children:a(`theory.quiz.tryAgain`)})]})]})},k={hidden:{opacity:0},show:{opacity:1,transition:{staggerChildren:.1}}},A={hidden:{opacity:0,y:20},show:{opacity:1,y:0}};function j(){let{t:i}=e(),a=l(),{moduleId:o}=c(),s=S.find(e=>e.id===o),[f,m]=(0,C.useState)(()=>{let e=u(`theory_progress`,[]);return Array.isArray(e)?e:[]}),g=e=>{if(!f.includes(e)){let t=[...f,e];m(t),v(`theory_progress`,t)}},_=e=>{a(`/theory/${e.id}`)};return(0,w.jsx)(b,{className:`p-6 pt-12 pb-24 min-h-screen bg-gradient-to-b from-slate-50 to-white`,children:(0,w.jsx)(h,{mode:`wait`,children:s?(0,w.jsxs)(d.div,{initial:{opacity:0,y:`100%`},animate:{opacity:1,y:0},exit:{opacity:0,y:`100%`},transition:{type:`spring`,damping:25,stiffness:200},className:`fixed inset-0 z-50 bg-gradient-to-b from-white to-slate-50 flex flex-col`,children:[(0,w.jsxs)(`div`,{className:`p-6 border-b border-slate-200 flex items-center gap-4 bg-white/90 backdrop-blur-md sticky top-0 shadow-sm z-50`,children:[(0,w.jsxs)(`button`,{onClick:()=>{a(`/theory`)},className:`flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors group`,children:[(0,w.jsx)(t,{size:18,className:`text-slate-600 group-hover:-translate-x-1 transition-transform`}),(0,w.jsx)(`span`,{className:`font-medium text-slate-700`,children:i(`common.back`)})]}),(0,w.jsxs)(`div`,{className:`flex-1`,children:[(0,w.jsx)(`h2`,{className:`text-xl font-bold text-slate-900`,children:s.title}),(0,w.jsx)(`p`,{className:`text-sm text-slate-500 mt-0.5`,children:s.description})]}),(0,w.jsx)(`div`,{className:`w-12`}),` `]}),(0,w.jsx)(`div`,{className:`flex-1 overflow-y-auto`,children:(0,w.jsxs)(`div`,{className:`max-w-3xl mx-auto p-6 pb-32`,children:[(0,w.jsxs)(`div`,{className:`mb-8 p-8 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl shadow-xl relative overflow-hidden`,children:[(0,w.jsx)(`div`,{className:`absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16`}),(0,w.jsx)(`div`,{className:`absolute bottom-0 left-0 w-24 h-24 bg-white/10 rounded-full -ml-12 -mb-12`}),(0,w.jsxs)(`div`,{className:`relative z-10`,children:[E[s.id]&&(0,w.jsx)(`div`,{className:`mb-6 flex justify-center`,children:(0,w.jsx)(`img`,{src:E[s.id],alt:s.title,loading:`lazy`,decoding:`async`,width:`192`,height:`192`,className:`w-48 h-48 object-contain rounded-2xl bg-white/10 p-4 backdrop-blur-sm`})}),(0,w.jsx)(`div`,{className:`inline-flex items-center justify-center w-16 h-16 ${s.color} bg-white/20 backdrop-blur-sm rounded-2xl mb-4`,children:(()=>(0,w.jsx)(T[s.id]||p,{size:32,className:`text-white`,strokeWidth:2.5}))()}),(0,w.jsx)(`h1`,{className:`text-3xl font-black text-white mb-2`,children:s.title}),(0,w.jsx)(`p`,{className:`text-blue-100 text-lg`,children:s.description})]})]}),(0,w.jsx)(`div`,{className:`bg-white rounded-3xl p-8 shadow-lg border border-slate-100 mb-8`,children:(0,w.jsx)(D,{content:s.content})}),s.quiz&&(0,w.jsx)(O,{quiz:s.quiz,onComplete:()=>g(s.id)}),(0,w.jsx)(`div`,{className:`mt-12 flex justify-end`,children:(0,w.jsxs)(`button`,{onClick:()=>{let e=S.findIndex(e=>e.id===s.id);e<S.length-1?(a(`/theory/${S[e+1].id}`),window.scrollTo(0,0)):a(`/theory`)},className:`flex items-center gap-2 px-8 py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-slate-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1`,children:[i(`theory.quiz.nextModule`),` `,(0,w.jsx)(n,{size:20})]})})]})})]},`detail`):(0,w.jsxs)(d.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:[(0,w.jsx)(`header`,{className:`mb-8`,children:(0,w.jsxs)(d.div,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},className:`flex items-center gap-3 mb-4`,children:[(0,w.jsx)(`div`,{className:`w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-200`,children:(0,w.jsx)(p,{size:24,className:`text-white`})}),(0,w.jsxs)(`div`,{children:[(0,w.jsx)(`h1`,{className:`text-4xl font-black text-slate-900 tracking-tight`,children:i(`theory.title`)}),(0,w.jsx)(`p`,{className:`text-slate-500 font-medium`,children:i(`theory.subtitle`)})]})]})}),(0,w.jsx)(d.div,{variants:k,initial:`hidden`,animate:`show`,className:`space-y-4`,children:S.map(e=>{let t=T[e.id]||p,a=e.id.replace(/-([a-z])/g,e=>e[1].toUpperCase()),o=f.includes(e.id);return(0,w.jsxs)(d.div,{variants:A,whileHover:{scale:1.02,y:-4},whileTap:{scale:.98},onClick:()=>_(e),className:`group bg-white rounded-3xl p-6 shadow-md border-2 border-slate-100 flex items-center gap-5 cursor-pointer hover:shadow-2xl hover:shadow-indigo-100/50 hover:border-indigo-200 transition-all duration-300 relative overflow-hidden`,children:[(0,w.jsx)(`div`,{className:`absolute inset-0 bg-gradient-to-r from-indigo-50/0 via-indigo-50/50 to-purple-50/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300`}),(0,w.jsxs)(`div`,{className:`relative w-16 h-16 rounded-2xl ${e.color} flex items-center justify-center text-white shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`,children:[(0,w.jsx)(t,{size:28,strokeWidth:2.5}),o&&(0,w.jsx)(`div`,{className:`absolute -top-2 -right-2 bg-green-500 text-white rounded-full p-1 border-2 border-white shadow-sm`,children:(0,w.jsx)(r,{size:12,fill:`currentColor`})})]}),(0,w.jsxs)(`div`,{className:`flex-1 relative z-10`,children:[(0,w.jsxs)(`h3`,{className:`text-xl font-bold text-slate-900 mb-1 group-hover:text-indigo-600 transition-colors flex items-center gap-2`,children:[i(`theory.${a}`,e.title),o&&(0,w.jsx)(`span`,{className:`text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full font-bold`,children:`Tamamlandı`})]}),(0,w.jsx)(`p`,{className:`text-slate-500 text-sm leading-snug`,children:e.description})]}),(0,w.jsx)(n,{size:24,className:`text-slate-300 group-hover:text-indigo-500 group-hover:translate-x-1 transition-all duration-300 relative z-10`})]},e.id)})})]},`list`)})})}export{j as default};