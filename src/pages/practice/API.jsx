                                                        ...
                                                        {headers.map((h, i) => (
                                                            <div key={i} className="flex flex-wrap sm:flex-nowrap gap-2 items-center">
                                                                <input
                                                                    ...
                                                                    className="w-full sm:w-auto sm:flex-1 bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-sm"
                                                                />
                                                                <input
                                                                    placeholder="Value"
                                                                    value={h.value}
                                                                    onChange={e => { const n = [...headers]; n[i].value = e.target.value; setHeaders(n) }}
                                                                    className="flex-1 min-w-0 bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-sm"
                                                                />
